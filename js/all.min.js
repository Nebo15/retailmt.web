                ...
                if (c = d.relative[a[i].type]) {
                    ...
                    if (c[u]) {
                        ...
                        return va(i > 1 && sa(m), i > 1 && qa(a.slice(0, i - 1).concat({
                            value: a[i - 2].type === " " ? "*" : ""
                        })).replace(R, "$1"), c, i < e && wa(a.slice(i, e)), e < f && wa(a = a.slice(e)), e < f && qa(a));
                    }
                    m.push(c);
                }
            }
        ...
        i = fa.select = function(a, b, e, f) {
            ...
            if (o.length === 1) {
                ...
                while (i--) {
                    ...
                    if (m = d.find[l]) {
                        if (f = m(k.matches[0].replace(ca, da), aa.test(j[0].type) && oa(b.parentNode) || b)) {
                            j.splice(i, 1);
                            a = f.length && qa(j);
                            if (!a) {
                                H.apply(e, f);
...
$(function() {
    ...
    var b = $(".section");
    var c = $(".scrollhelp");
    var d = c.filter(".scrollhelp-prev");
    var e = c.filter(".scrollhelp-next");
    var f = b.first();
    var g = b.last();
    var h = b.find(".container-fixed");
    var i = window.navigator.userAgent;
    var j = i.match(/iPad/i) || i.match(/iPhone/i) || i.match(/iPod/i);
    var k = f.height();
    var l = 0;
    var m = g.offset().top;
    var n = a.pageYOffset || a.scrollTop();
    function o() {
        n = a.pageYOffset || a.scrollTop();
    }
    function p() {
        k = f.outerHeight();
        l = 0;
        ...
        h.each(function() {
            var a = $(this);
            a.data("parent-offset-top", a.parent().offset().top);
            a.data("parent-offset-bottom", a.parent().offset().top + a.parent().height());
        });
    }
    function q(a) {
        var c = n + (a ? a : 0);
    ...
    function s() {
        ...
        (function() {
            ...
            var g = q(60);
            if (g && g.length > 0) {
                $(".menu-list__item").filter(":has(a[href=#slide" + r(g) + "])").each(function() {
                    var a = $(this);
        ...
        (function() {
            h.each(function() {
                var a = $(this);
                var b, c;
                c = a.data("parent-offset-bottom") - n;
                if (a.parent().is(f)) {
                    b = 0;
                } else {
                    b = a.data("parent-offset-top") - n;
                    if (b < 0) {
                        b = 0;
                    }
                    if (b > k) {
    ...
    (function() {
        ...
        if (j) {
            d.add(e).remove();
            b.css("background-attachment", "scroll");
        } else {
            (function() {
                h.css({
                    position: "fixed",
            ...
            (function() {
                d.find(".scrollhelp-btn").click(function() {
                    var b = q(a.height() / 2).prev(".section");
                    var c = b.length > 0 ? b.offset().top : l;
                    t(c);
                });
                e.find(".scrollhelp-btn").click(function() {
                    var a = q().next(".section");
                    var b = a.length > 0 ? a.offset().top : m;
                    t(b);
                });
                $(window).keydown(function(a) {
                    if (a.which == 38) {
                        a.preventDefault();
                        d.find(".scrollhelp-btn").click();
                    } else if (a.which == 40 || a.which == 40 || a.which == 32) {
                        a.preventDefault();
                        e.find(".scrollhelp-btn").click();
                    } else if (a.which == 37) {
                        t(0);
                    } else if (a.which == 39) {
                        a.preventDefault();
    ...
    (function() {
        $(".menu-list__item").click(function(a) {
            a.preventDefault();
